...
FILELIST=/home/bo/Desktop/omega/datapath

# 0 for all files in FILELIST; everything else for desired number
numberOfFilesToAnalyse=0

root -b compile.C
rm /home/bo/Desktop/omega/dataout/*
rm /home/bo/Desktop/omega/dataoutpath
...
while read FILE; do
  ...
  echo "mv output$iFile.root dataout/" >> $jobscript
