...
FILELIST=/home/bo/Desktop/omega/mceegpath

# 0 for all files in FILELIST; everything else for desired number
numberOfFilesToAnalyse=0

root -b compile.C
rm /home/bo/Desktop/omega/mceegout/*
rm /home/bo/Desktop/omega/mceegoutpath
...
while read FILE; do
  ...
  echo "mv output$iFile.root mceegout/" >> $jobscript
